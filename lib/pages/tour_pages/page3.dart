...
class Page3State extends State<Page3> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body:  ListView(
          ...
          children: <Widget>[
            Card(
              child: Image.asset('images/tour_images/entrance_facade.jpg'),
            ),
            Card(
              child: Padding(
                padding: EdgeInsets.all(8),
            ...
            Card(
              child: Padding(
                ...
                child: Column(
                  children: <Widget>[
                    Text(AppLocalizations.of(context).entranceFacadeInstructions,
                      style: TextStyle(
                          fontSize: 16,
  ...
  Widget playButton(BuildContext context) {
    String audio = AppLocalizations.of(context).entranceFacadeText;
    return  FlatButton(
      onPressed: () {
        setState(() {
