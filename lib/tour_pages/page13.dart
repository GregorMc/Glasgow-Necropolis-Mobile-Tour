...
class Page13State extends State<Page13> {
    ...
    return DefaultTabController(
      ...
      child: Scaffold(
        ...
        body:  ListView(
          ...
          children: <Widget>[
            Card(
              child: Image.asset('images/tour_images/johnknoxmonument.jpg'),
            ),
            Card(
              child: Padding(
                padding: EdgeInsets.all(8),
                child: Column(
                  children: <Widget>[
                    Text(AppLocalizations.of(context).johnKnoxText,
  ...
  Widget playButton(BuildContext context) {
    String audio = AppLocalizations.of(context).johnKnoxText;
    return  FlatButton(
        onPressed: () {
          setState(() {
